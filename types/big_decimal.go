...
// Dec returns the sdk.Dec representation of a BigDec.
...
func (d BigDec) Dec() sdk.Dec {
	...
	truncatedDec := sdk.NewDecFromBigIntWithPrec(intRepresentation, PrecisionDec)

	return truncatedDec
}

// DecRoundUp returns the sdk.Dec representation of a BigDec.
// Round up at precision end.
// Values in any additional decimal places are truncated.
func (d BigDec) DecRoundUp() sdk.Dec {
	return sdk.NewDecFromBigIntWithPrec(chopPrecisionAndRoundUpDec(d.i), PrecisionDec)
}

// BigDecFromDec returns the BigDec representation of an Dec.
// Values in any additional decimal places are truncated.
func BigDecFromDec(d sdk.Dec) BigDec {
	return NewBigDecFromBigIntWithPrec(d.BigInt(), PrecisionDec)
}

// BigDecFromDecSlice returns the []BigDec representation of an []Dec.
// Values in any additional decimal places are truncated.
func BigDecFromDecSlice(ds []sdk.Dec) []BigDec {
