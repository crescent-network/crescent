...
// EthSigVerificationGasConsumer is the crescent implementation of SignatureVerificationGasConsumer. It consumes gas
...
func EthSigVerificationGasConsumer(
	...
	case *ethsecp256k1.PubKey:
		...
		return nil
	// TODO: temporary allow also cosmos secp256k1
...
func ConsumeMultisignatureVerificationGas(
	...
	for i := 0; i < size; i++ {
		...
		err := EthSigVerificationGasConsumer(meter, sigV2, params)
		if err != nil {
			return err
		}
		sigIndex++
