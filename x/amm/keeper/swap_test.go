...
func (s *KeeperTestSuite) TestQueryBestSwapExactAmountInRoutes() {
	...
	s.AssertEqual(utils.ParseDecCoin("142918.117689604923591863uatom"), resp.Results[0].Fee)
	...
	s.AssertEqual(utils.ParseDecCoin("1461241.196265277979044800uusd"), resp.Results[1].Fee)
}
