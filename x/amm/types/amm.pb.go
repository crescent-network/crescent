...
type ExecutedQuantity struct {
	Quantity github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,1,opt,name=quantity,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"quantity"`
}

func (m *ExecutedQuantity) Reset()         { *m = ExecutedQuantity{} }
func (m *ExecutedQuantity) String() string { return proto.CompactTextString(m) }
func (*ExecutedQuantity) ProtoMessage()    {}
func (*ExecutedQuantity) Descriptor() ([]byte, []int) {
	return fileDescriptor_1dfef6a2c44f2449, []int{4}
}
func (m *ExecutedQuantity) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ExecutedQuantity) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ExecutedQuantity.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ExecutedQuantity) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExecutedQuantity.Merge(m, src)
}
func (m *ExecutedQuantity) XXX_Size() int {
	return m.Size()
}
func (m *ExecutedQuantity) XXX_DiscardUnknown() {
	xxx_messageInfo_ExecutedQuantity.DiscardUnknown(m)
}

var xxx_messageInfo_ExecutedQuantity proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*ExecutedQuantity)(nil), "crescent.amm.v1beta1.ExecutedQuantity")
}
...
var fileDescriptor_1dfef6a2c44f2449 = []byte{
	...
	,
}
...
func (m *ExecutedQuantity) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ExecutedQuantity) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ExecutedQuantity) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ExecutedQuantity) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ExecutedQuantity) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ExecutedQuantity: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ExecutedQuantity: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
