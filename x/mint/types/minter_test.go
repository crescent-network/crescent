...
//
//	// Governing Mechanism:
//	//    BlockTimeThresholdPerYear = (1- BondedRatio/ GoalBonded) * MaxBlockTimeThreshold
//
//	tests := []struct {
//		bondedRatio, setInflation, expChange sdk.Dec
//	}{
//		// with 0% bonded atom supply the inflation should increase by BlockTimeThreshold
//		{sdk.ZeroDec(), sdk.NewDecWithPrec(7, 2), params.BlockTimeThreshold.Quo(blocksPerYr)},
//
//		// 100% bonded, starting at 20% inflation and being reduced
//		// (1 - (1/0.67))*(0.13/8667)
//		{sdk.OneDec(), sdk.NewDecWithPrec(20, 2),
//			sdk.OneDec().Sub(sdk.OneDec().Quo(params.GoalBonded)).Mul(params.BlockTimeThreshold).Quo(blocksPerYr)},
//
//		// 50% bonded, starting at 10% inflation and being increased
//		{sdk.NewDecWithPrec(5, 1), sdk.NewDecWithPrec(10, 2),
//			sdk.OneDec().Sub(sdk.NewDecWithPrec(5, 1).Quo(params.GoalBonded)).Mul(params.BlockTimeThreshold).Quo(blocksPerYr)},
//
