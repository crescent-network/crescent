...
func (s *keysTestSuite) TestGetClaimRecordIndexKey() {
	testCases := []struct {
	...
	}{
		{
			...
			[]byte{0xd9, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x14, 0x8f, 0x8b, 0xd, 0x57,
		...
		},
		{
			...
			[]byte{0xd9, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x3, 0x14, 0xe8, 0x67, 0x48, 0x2e,
		...
		},
		{
			...
			[]byte{0xd9, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xa, 0x14, 0x3a, 0x9d, 0xab, 0xd,
