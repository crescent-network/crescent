...
func TestProposalContents(t *testing.T) {
	...
	require.Equal(t, "wNbeHVIkPZ", content0.GetTitle())
	require.Equal(t, "ODFRregDTqGNoFBIHxvimmIZwLfFyKUfEWAnNBdtdzDmTPXtpHRGdIbuucfTjOygZsTxPjfweXhSUkMhPjMaxKlMIJMOXcnQfyze", content0.GetDescription())
	...
	require.Equal(t, "RuFwMRYUiK", content1.GetTitle())
	require.Equal(t, "SGLqwTMcxHfWotDllNkIJPMbXzjDVjPOOjCFuIvTyhXKLyhUScOXvYthRXpPfKwMhptXaxIxgqBoUqzrWbaoLTVpQoottZyPFfNO", content1.GetDescription())
	...
	require.Equal(t, "SKtPDMEoEQ", content2.GetTitle())
	require.Equal(t, "nCqFrUGMCRZUGJKTZIGPyldsifauoMnJPLTcDHmilcmahlqOELaAUYDBuzsVywnDQfwRLGIWozYaOAilMBcObErwgTDNGWnwQMUg", content2.GetDescription())
