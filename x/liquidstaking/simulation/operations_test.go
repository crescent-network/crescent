...
//	app.LiquidstakingKeeper.SetParams(ctx, params)
//
//	// begin a new block
//	app.BeginBlock(abci.RequestBeginBlock{Header: tmproto.Header{Height: app.LastBlockHeight() + 1, AppHash: app.LastCommitID().Hash}})
//
//	// execute operation
//	op := simulation.SimulateMsgCreateFixedAmountPlan(app.AccountKeeper, app.BankKeeper, app.LiquidstakingKeeper)
...
//
//	// execute operation
//	op := simulation.SimulateMsgCreateRatioPlan(app.AccountKeeper, app.BankKeeper, app.LiquidstakingKeeper)
//	operationMsg, futureOperations, err := op(r, app.BaseApp, ctx, accounts, "")
//	require.NoError(t, err)
//
...
//
//	// execute operation
//	op := simulation.SimulateMsgLiquidStake(app.AccountKeeper, app.BankKeeper, app.LiquidstakingKeeper)
//	operationMsg, futureOperations, err := op(r, app.BaseApp, ctx, accounts, "")
//	require.NoError(t, err)
//
...
//	err := app.LiquidstakingKeeper.Stake(ctx, accounts[0].Address, stakingCoins)
//	require.NoError(t, err)
//
//	// begin a new block and advance epoch
//	app.BeginBlock(abci.RequestBeginBlock{Header: tmproto.Header{Height: app.LastBlockHeight() + 1, AppHash: app.LastCommitID().Hash}})
//	err = app.LiquidstakingKeeper.AdvanceEpoch(ctx)
//	require.NoError(t, err)
//
//	// execute operation
//	op := simulation.SimulateMsgLiquidUnstake(app.AccountKeeper, app.BankKeeper, app.LiquidstakingKeeper)
//	operationMsg, futureOperations, err := op(r, app.BaseApp, ctx, accounts, "")
//	require.NoError(t, err)
//
...
//	_, err := app.LiquidstakingKeeper.CreateFixedAmountPlan(
//		ctx,
...
//
//	// stake
//	err = app.LiquidstakingKeeper.Stake(ctx, accounts[1].Address, sdk.NewCoins(sdk.NewInt64Coin(sdk.DefaultBondDenom, 100_000_000)))
//	require.NoError(t, err)
//
//	_, qsf := app.LiquidstakingKeeper.GetQueuedStaking(ctx, sdk.DefaultBondDenom, accounts[1].Address)
//	require.True(t, qsf)
//
//	// begin a new block and advance epoch
//	app.BeginBlock(abci.RequestBeginBlock{Header: tmproto.Header{Height: app.LastBlockHeight() + 1, AppHash: app.LastCommitID().Hash}})
...
//	_, sf := app.LiquidstakingKeeper.GetStaking(ctx, sdk.DefaultBondDenom, accounts[1].Address)
//	require.True(t, sf)
//
//	err = app.LiquidstakingKeeper.AdvanceEpoch(ctx)
//	require.NoError(t, err)
//
//	// execute operation
//	op := simulation.SimulateMsgHarvest(app.AccountKeeper, app.BankKeeper, app.LiquidstakingKeeper)
//	operationMsg, futureOperations, err := op(r, app.BaseApp, ctx, accounts, "")
//	require.NoError(t, err)
//
