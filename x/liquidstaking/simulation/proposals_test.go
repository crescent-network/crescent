...
//	weightedProposalContent := simulation.ProposalContents(app.AccountKeeper, app.BankKeeper, app.LiquidstakingKeeper)
...
//	require.Equal(t, "liquidstaking", content0.ProposalRoute())
...
//	require.Equal(t, "liquidstaking", content1.ProposalRoute())
...
//	require.Equal(t, "liquidstaking", content2.ProposalRoute())
