...
func (s *KeeperTestSuite) TestFoo() {
	...
	market := s.CreateSpotMarket(utils.TestAddress(3), "ucre", "uusd", true)

	s.PlaceSpotLimitOrder(market.Id, aliceAddr, true, utils.ParseDec("100"), sdk.NewInt(1000))
	s.PlaceSpotLimitOrder(market.Id, aliceAddr, true, utils.ParseDec("99"), sdk.NewInt(1000))
	s.PlaceSpotLimitOrder(market.Id, aliceAddr, true, utils.ParseDec("97"), sdk.NewInt(1000))

	s.PlaceSpotLimitOrder(
