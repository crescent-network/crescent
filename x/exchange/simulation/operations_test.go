...
func (s *SimTestSuite) TestSimulateMsgPlaceLimitOrder() {
	...
	s.Require().Equal(true, msg.IsBuy)
	s.AssertEqual(utils.ParseDec("9.5918"), msg.Price)
	s.AssertEqual(sdk.NewInt(91289), msg.Quantity)
...
func (s *SimTestSuite) TestSimulateMsgPlaceMarketOrder() {
	...
	s.AssertEqual(sdk.NewInt(16440), msg.Quantity)
}
