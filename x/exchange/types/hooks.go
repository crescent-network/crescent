...
type ExchangeHooks interface {
	AfterSpotOrderExecuted(ctx sdk.Context, order SpotOrder, qty sdk.Int)
}
...
func (hs MultiExchangeHooks) AfterSpotOrderExecuted(ctx sdk.Context, order SpotOrder, qty sdk.Int) {
	for _, h := range hs {
