...
// source: crescent/exchange/v1beta1/order_book.proto
...
type OrderBook struct {
	PriceInterval github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=price_interval,json=priceInterval,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"price_interval"`
...
func (*OrderBook) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b67a809c8fd6ad6, []int{0}
}
...
type OrderBookPriceLevel struct {
	...
	// q denotes quantity
	Q github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,2,opt,name=q,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"q"`
}

func (m *OrderBookPriceLevel) Reset()         { *m = OrderBookPriceLevel{} }
func (m *OrderBookPriceLevel) String() string { return proto.CompactTextString(m) }
func (*OrderBookPriceLevel) ProtoMessage()    {}
func (*OrderBookPriceLevel) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b67a809c8fd6ad6, []int{1}
}
...
func (m *OrderBookPriceLevel) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_OrderBookPriceLevel.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *OrderBookPriceLevel) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OrderBookPriceLevel.Merge(m, src)
}
func (m *OrderBookPriceLevel) XXX_Size() int {
	return m.Size()
}
func (m *OrderBookPriceLevel) XXX_DiscardUnknown() {
	xxx_messageInfo_OrderBookPriceLevel.DiscardUnknown(m)
}

var xxx_messageInfo_OrderBookPriceLevel proto.InternalMessageInfo

func init() {
	proto.RegisterType((*OrderBook)(nil), "crescent.exchange.v1beta1.OrderBook")
	proto.RegisterType((*OrderBookPriceLevel)(nil), "crescent.exchange.v1beta1.OrderBookPriceLevel")
}

func init() {
	proto.RegisterFile("crescent/exchange/v1beta1/order_book.proto", fileDescriptor_0b67a809c8fd6ad6)
}

var fileDescriptor_0b67a809c8fd6ad6 = []byte{
	// 325 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *OrderBook) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	{
		size := m.PriceInterval.Size()
		i -= size
		if _, err := m.PriceInterval.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintOrderBook(dAtA, i, uint64(size))
	}
...
func (m *OrderBook) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.PriceInterval.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			m.Sells = append(m.Sells, OrderBookPriceLevel{})
		...
		case 3:
			...
			m.Buys = append(m.Buys, OrderBookPriceLevel{})
...
func (m *OrderBookPriceLevel) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: OrderBookPriceLevel: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: OrderBookPriceLevel: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
