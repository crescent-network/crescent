...
func TestGetLiquidFarmKey(t *testing.T) {
	require.Equal(
		t, []byte{0xe3, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1}, types.GetLiquidFarmKey(1))
	require.Equal(
		t, []byte{0xe3, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0xf4}, types.GetLiquidFarmKey(500))
	require.Equal(
		t, []byte{0xe3, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x27, 0x10}, types.GetLiquidFarmKey(10000))
}

func TestGetRewardsAuctionKey(t *testing.T) {
	require.Equal(
		t, []byte{0xe4, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1,
	...
	require.Equal(
		t, []byte{0xe4, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x27, 0x10,
