...
func request_Query_LiquidFarm_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	val, ok = pathParams["liquid_farm_id"]
	if !ok {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "missing parameter %s", "liquid_farm_id")
	}

	protoReq.LiquidFarmId, err = runtime.Uint64(val)

	if err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "type mismatch, parameter: %s, error: %v", "liquid_farm_id", err)
	}
...
var (
	filter_Query_RewardsAuctions_0 = &utilities.DoubleArray{Encoding: map[string]int{"liquid_farm_id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
var (
	filter_Query_Bids_0 = &utilities.DoubleArray{Encoding: map[string]int{"liquid_farm_id": 0, "auction_id": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)
...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"crescent", "liquidfarming", "v1beta1", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_LiquidFarms_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"crescent", "liquidfarming", "v1beta1", "liquidfarms"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_LiquidFarm_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"crescent", "liquidfarming", "v1beta1", "liquidfarms", "liquid_farm_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_RewardsAuctions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"crescent", "liquidfarming", "v1beta1", "liquidfarms", "liquid_farm_id", "rewards_auctions"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_RewardsAuction_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6}, []string{"crescent", "liquidfarming", "v1beta1", "liquidfarms", "liquid_farm_id", "rewards_auctions", "auction_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Bids_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6, 2, 7}, []string{"crescent", "liquidfarming", "v1beta1", "liquidfarms", "liquid_farm_id", "rewards_auctions", "auction_id", "bids"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Rewards_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"crescent", "liquidfarming", "v1beta1", "liquidfarms", "liquid_farm_id", "rewards"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ExchangeRate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"crescent", "liquidfarming", "v1beta1", "liquidfarms", "liquid_farm_id", "exchange_rate"}, "", runtime.AssumeColonVerbOpt(false)))
)
