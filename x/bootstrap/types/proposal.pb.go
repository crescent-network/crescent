...
type BootstrapProposal struct {
	...
	PairId uint64 `protobuf:"varint,7,opt,name=pair_id,json=pairId,proto3" json:"pair_id,omitempty"`
	...
	StageDuration time.Duration `protobuf:"bytes,12,opt,name=stage_duration,json=stageDuration,proto3,stdduration" json:"stage_duration"`
...
type InitialOrder struct {
	...
	AssociateStage uint32         `protobuf:"varint,4,opt,name=associate_stage,json=associateStage,proto3" json:"associate_stage,omitempty"`
}
...
var fileDescriptor_a91229c2c9a1c550 = []byte{
	...
	,
}
...
func (m *InitialOrder) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.AssociateStage != 0 {
		i = encodeVarintProposal(dAtA, i, uint64(m.AssociateStage))
		i--
		dAtA[i] = 0x20
	}
	if m.Direction != 0 {
...
func (m *InitialOrder) Size() (n int) {
	...
	if m.AssociateStage != 0 {
		n += 1 + sovProposal(uint64(m.AssociateStage))
	}
	return n
}
