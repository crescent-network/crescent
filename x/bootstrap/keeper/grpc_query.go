...
func (k Querier) Bootstraps(c context.Context, req *types.QueryBootstrapsRequest) (*types.QueryBootstrapsResponse, error) {
	if req == nil {
	...
	return &types.QueryBootstrapsResponse{Marketmakers: mmsRes, Pagination: pageRes}, nil
}
