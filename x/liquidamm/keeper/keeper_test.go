...
func (s *KeeperTestSuite) SetupSampleScenario() {
	...
	s.MintShare(minterAddr2, publicPosition.Id, utils.ParseCoins("300_000000ucre,1500_000000uusd"), true)
	...
	bidderShare1, _, _, _ := s.MintShare(bidderAddr1, publicPosition.Id, utils.ParseCoins("10_000000ucre,50_000000uusd"), true)
	bidderShare2, _, _, _ := s.MintShare(bidderAddr2, publicPosition.Id, utils.ParseCoins("20_000000ucre,100_000000uusd"), true)
	bidderShare3, _, _, _ := s.MintShare(bidderAddr3, publicPosition.Id, utils.ParseCoins("30_000000ucre,150_000000uusd"), true)
	s.PlaceBid(bidderAddr1, publicPosition.Id, auction.Id, bidderShare1)
	s.PlaceBid(bidderAddr2, publicPosition.Id, auction.Id, bidderShare2)
	s.PlaceBid(bidderAddr3, publicPosition.Id, auction.Id, bidderShare3)
	...
	s.MintShare(minterAddr3, publicPosition.Id, utils.ParseCoins("500_000000ucre,2500_000000uusd"), true)
